...
#define TEMP_CON_Pin GPIO_PIN_2
...
#define USB_VOLT_DET_Pin GPIO_PIN_0
#define USB_VOLT_DET_GPIO_Port GPIOB
#define PEN_VOLT_DET_Pin GPIO_PIN_1
#define PEN_VOLT_DET_GPIO_Port GPIOB
